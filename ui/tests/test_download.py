...
class TestDownload:
    @patch("edgar_ui.backend.routes.download.get_config")
    @patch("edgar_ui.backend.routes.download.EdgarClient")
    @patch("edgar_ui.backend.routes.download.download_company")
